...
layui.use(['element', 'layer', 'util','jquery'], function(){
   ...
   //                                            $('#OperatorId').val($('#AccountDisplay',parent.document).text());
                                      ...
                                      yes: function(index,layero){
                                         ...
                                         if($('#ServerNameInfo').val()=='') layer.msg('昵称不能为空');
                                         else if($('#ServerPhoneInfo').val()=='') layer.msg('电话号码不能为空');
                                         else if($('#ServerGenderInfo').val()=='') layer.msg('性别不能为空');
                                         else if($('#ServerRemark').val()=='') layer.msg('备注不能为空');
                                         else{
                                               $.ajax({
                                                                                        url:"/ServerEditProfile",
                                                                                        type:"post",
                                                                                        data: {
                                                                                            "Name":$('#ServerNameInfo').val(),
                                                                                            "Phone":$('#ServerPhoneInfo').val(),
                                                                                            "Gender":$('#ServerGenderInfo').val(),
                                                                                            "Remark":$('#ServerRemarkInfo').val(),
